...
var _verifyInit = function () {
  if (!initialized) {
    console.warn('Pixel not initialized before using call TrackingByFacebook.init with required params');
  }
  return initialized;
}

var TrackingByFacebook = {
...
module.exports = TrackingByFacebook;